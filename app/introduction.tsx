  ...
  return (
    <div className='text-center flex flex-col  h-screen  justify-center '>
       <div className='hover:scale-105 transition-transform duration-300 cursor-pointer'>
        <h1 className=' hover:bg-black dark:hover:bg-white transition-all duration-500 bg-clip-text text-transparent  bg-gradient-to-r from-primary to-primary/40 md:text-[5rem] sm:text-[4.2rem]  text-[3.7rem] leading-15 sm:leading-none  font-bold '>James Jimenez</h1>
       </div>
       ...
       <div className='flex gap-2 flex-col sm:flex-row items-center mx-auto w-1/2  justify-center'>
        ...
        <Button variant={'outline'} className=' cursor-pointer hover:scale-105 transition-transform duration-300 font-semibold px-9 border-slate-700  py-3 sm:py-5 flex-1/12
         items-center justify-center text-center'>
           ...
           <a href='https://github.com/jamesjimenezzz' target='_blank' className='cursor-pointer text-xs sm:text-sm'>Github</a>
        </Button>
       </div>
        </div>
  )
